...
<li <?php if (preg_match("/dashboard/i", $url)) { ?>class="active" <?php } ?>><a href="{{url('/admin/dashboard')}}"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Counpons</span> <span class="label label-important">3</span></a>
    <ul <?php if (preg_match("/coupon/i", $url)) { ?>style="display:block;" <?php } ?>>>
         <li <?php if (preg_match("/add-coupon/i", $url)) { ?>class="active" <?php } ?>>><a href="{{ url('/admin/add-coupon') }}">Add Counpon</a></li>
         <li <?php if (preg_match("/view-coupons/i", $url)) { ?>class="active" <?php } ?>>><a href="{{ url('/admin/view-coupons') }}">View Counpons</a></li>
      </ul>
    </li>
