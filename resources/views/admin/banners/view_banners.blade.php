            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <img src="{{ asset('/images/frontend_images/banners/'.$banner->image) }}" style="width:260px;">;
                  @endif
                  </td>
                  <td class="center">
                  <a href="{{ url('/admin/edit-banner/'.$banner->id )}}" class="btn btn-primary btn-mini" title="Edit banner">Edit</a>
                  <a rel="{{ $banner->id }}" rel1="delete-banner" <?php /*href="{{ url('/admin/delete-banner/'.$banner->id )}}" */?> href="javascript:" class="btn btn-danger btn-mini deleteRecord" title="Delete Banner">Delete</a></td>
                </tr>
                @endforeach
                </tbody>
            </table>
