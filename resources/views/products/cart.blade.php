				...
				<div class="col-sm-6">
					<div class="total_area">
						...
						@if(!empty(Session::get('CouponAmount')))
							<li>Sub Total <span>NPR <?php echo $total_amount; ?></span></li>
							<li>Coupon Discount <span>NPR <?php echo Session::get('CouponAmount'); ?></span></li>
							<li>Grand Total <span>NPR <?php echo $total_amount-Session::get('CouponAmount'); ?></span></li>
							@else
							<li>Grand Total <span>NPR <?php echo $total_amount; ?></span></li>
							@endif
